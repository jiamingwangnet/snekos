...
void init_idt()
{
    ...
    add_idt_entry(32, (uint64_t)&irq0, 0x8, 0x8E);
    add_idt_entry(33, (uint64_t)&irq1, 0x8, 0x8E);
    add_idt_entry(35, (uint64_t)&irq3, 0x8, 0x8E);
    add_idt_entry(36, (uint64_t)&irq4, 0x8, 0x8E);
    add_idt_entry(37, (uint64_t)&irq5, 0x8, 0x8E);
    add_idt_entry(38, (uint64_t)&irq6, 0x8, 0x8E);
    add_idt_entry(39, (uint64_t)&irq7, 0x8, 0x8E);
    add_idt_entry(40, (uint64_t)&irq8, 0x8, 0x8E);
    add_idt_entry(41, (uint64_t)&irq9, 0x8, 0x8E);
    add_idt_entry(42, (uint64_t)&irq10, 0x8, 0x8E);
    add_idt_entry(43, (uint64_t)&irq11, 0x8, 0x8E);
    add_idt_entry(44, (uint64_t)&irq12, 0x8, 0x8E);
