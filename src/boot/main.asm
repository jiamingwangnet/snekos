...
start:
    ...
    or eax, 0b10000011
    mov [page_table_l2 - 0xC0000000], eax
...
setup_tables:
    mov eax, (page_table_l3 - 0xC0000000)
    or eax, 0b11 ; present bit and writable bit
    mov dword [(page_table_l4 - 0xC0000000) + 0], eax ; make page_table_l4 point to page_table_l3

    mov eax, (page_table_l2 - 0xC0000000)
    or eax, 0b11
    mov dword [(page_table_l3 - 0xC0000000) + 0], eax
...
.map_l2_table: ; maps the l2 table to point to valid pages
    ...
    mov [(page_table_l2 - 0xC0000000) + ecx * 8], eax ; write the page into the table
...
enable_paging:
    mov eax, (page_table_l4 - 0xC0000000) ; cannot directly move to cr3
